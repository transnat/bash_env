...
alias ppaste="xclip -o -sel clip | xargs cd"
alias pylint="pylint --rcfile ${HOME}/.config/pylint/pylint.pylintrc"
alias q="exit"
alias rmf="rm -rf"
alias s="screen"
...
alias yamllint="yamllint -d ${HOME}/.config/yamllint/yamllint.yml"
